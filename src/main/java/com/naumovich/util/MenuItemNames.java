...
public final class MenuItemNames {

	public static final String ACTION_ADD_NODES = "Add nodes";
	...
	public static final String CONTROL_MENU_NAME = "Control";
	public static final String NODE_MENU_NAME = "Nodes";
